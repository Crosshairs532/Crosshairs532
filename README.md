...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,react,css,express,figma,firebase,materialui,mongodb,netlify,ps,py,tailwind,vercel,nodejs,nextjs,redux,prisma,mysql,postgres,py,ts,graphql)](https://skillicons.dev)
